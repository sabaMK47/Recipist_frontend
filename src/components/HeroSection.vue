<template>
    <section class="w-full max-w-screen py-40 px-10">
      <div class="flex flex-col lg:flex-row items-center justify-center gap-20 lg:gap-0">
        ...
        <!-- Image Section -->
        <div class="flex flex-col items-center gap-4 w-full right-0 position-relative lg:w-1/3">
          <div class="flex gap-4 justify-center">
            <img src="../assets/images/chicken.jpg" alt="chicken" class="rounded-2xl w-30 h-30  lg:w-40 lg:h-40 object-cover" />
            <img src="../assets/images/pasta.jpg" alt="pasta" class="rounded-2xl w-30 h-30  lg:w-40 lg:h-40 object-cover" />
          </div>
          <img src="../assets/images/sezar.jpg" alt="sezar salad" class="rounded-2xl w-30 h-30 lg:w-40 lg:h-40 object-cover" />
        </div>
